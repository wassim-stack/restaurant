...
export const NavBar = () => {
  ...
  return (
    ...
    <div className='max-w-full bg-white mx-auto sticky-top justify-between items-center flex p-4 space-x-7'>
       <div className='flex items-center '>
         ...
         {/* {Search Bar} */}
         <div className='flex border-b-4 border-black items-center px-2 w-[200px] sw:w-[400px] lg:w-[500px]'>
         ...
         {/* {Overlay => kel fasa thesa fouk site} */}
         {!nav ?( <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'>
         </div>):""}
    <div>
     {/* {Side Drawer menu} */}
     <div className={!nav ? 'fixed top-2 left-2 w-[300px] h-screen  bg-white z-10 duration-300':'fixed top-2 left-[-100%] w-[300px] h-screen  bg-white z-10 duration-300'}>
